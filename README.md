...
## Примечание по версии Fedora Server

В исходном задании была указана Fedora Server 43.
В процессе выполнения проекта использовалась Fedora Server 44, так как Fedora 43 на момент выполнения работы была переведена в архив и недоступна для стандартной загрузки с официального сайта Fedora.

Все используемые команды и конфигурации полностью совместимы с Fedora Server 44.
